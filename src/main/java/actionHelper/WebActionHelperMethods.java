...
public class WebActionHelperMethods {
    ...
    public void writeOnEditText(String data, String locator) {
     ...
     * @param xpath
     */
    public void ClearEditField(String locator) {
     ...
     * @param xpath
     */
    public void ClearTextArea(String locator) {
        driver.findElement(By.id(locator)).clear();
    }
...
*//*
    ...
    public boolean checkForSubstring(String First, String Second) {
